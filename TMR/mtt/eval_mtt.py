...
# texts_gt: list(str) - 60 elementi per mtt
text_latents_gt = tmr_forward(texts_gt)
# motions_guofeats_gt: list(tensor(n_frames, 263)) - 60 elementi per mtt
motion_latents_gt = tmr_forward(motions_guofeats_gt) 
# text_latents_gt: tensor(60, 256) - motion_latents_gt: tensor(60, 256)
